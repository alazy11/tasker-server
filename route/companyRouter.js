...
COMPANY.route('/clip/:clipID').get(authJWTUser,Company.getClip).put(authJWTUser,Company.renameClip).delete(authJWTUser,Company.deleteClip);
COMPANY.route('/clip/:clipID/download').get(authJWTUser,Company.downloadClip);
